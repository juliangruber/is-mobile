...
function isMobile (ua, opt) {
  ...
  if (typeof ua != 'string') return false
	...
	var isTablet = !!(opt && opt.tablets)

  return (isTablet ? tabletRE.test(ua) : mobileRE.test(ua)) || restRE.test(ua.substr(0,4))
}
